...
Carta** criarBaralho(TipoBaralho tipoBaralho) 
{
    ...
    switch (tipoBaralho) 
    {
        case BARALHO_GUERREIRO:
            ...
            cartas[5] = criarCarta("Impacto Explosivo", 2, DEFESA, 4, "Uma poderosa onda de choque é gerada, deixando os monstros confusos e lhe da \033[1;41m4 de Escudo\033[0m.");
            break;
        case BARALHO_MAGO:
            // Nome, Energia, Acao, QuantidadeAcao, Descricao
